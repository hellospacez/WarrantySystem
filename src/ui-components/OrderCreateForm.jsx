...
export default function OrderCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setReasonForFailure(initialValues.ReasonForFailure);
    setBatterySerialNumber(initialValues.BatterySerialNumber);
    setDateofPurchas(initialValues.DateofPurchas);
    setPlaceofPurchase(initialValues.PlaceofPurchase);
    setLocationofPurchase(initialValues.LocationofPurchase);
    setItemsRunningOffBattery(initialValues.ItemsRunningOffBattery);
    setApplianceAverageRunTime(initialValues.ApplianceAverageRunTime);
    setInverterDetail(initialValues.InverterDetail);
    setInverterBrand(initialValues.InverterBrand);
    setInverterModel(initialValues.InverterModel);
    setMaxCurrent(initialValues.MaxCurrent);
    setInRushCurrent(initialValues.InRushCurrent);
    setChargerDetails(initialValues.ChargerDetails);
    setChargerBrand(initialValues.ChargerBrand);
    setChargerModel(initialValues.ChargerModel);
    setChargerType(initialValues.ChargerType);
    setMultipleChargers(initialValues.MultipleChargers);
    setLithiumProfile(initialValues.LithiumProfile);
    setUnderBonnetApplication(initialValues.UnderBonnetApplication);
    setStartingOrCranking(initialValues.StartingOrCranking);
    setExtremeTemperatures(initialValues.ExtremeTemperatures);
    setCurrentApplicationLocation(initialValues.CurrentApplicationLocation);
    setMovedToAnotherApplication(initialValues.MovedToAnotherApplication);
    setAcknowledge(initialValues.Acknowledge);
    setReceiveCommunication(initialValues.ReceiveCommunication);
    setErrors({});
  };
  const validations = {
